!(function (n, e) {
  ...
  var e = Element.prototype,
    ...
    l = function (n, e) {
      ...
      for (var t = r.all(e, n.parentNode), i = 0; i < t.length; ++i)
        if (t[i] == n) return !0;
      return !1;
    };
  try {
  ...
  var t = function (n, e) {
    ...
    p = { previousText: 'PREVIOUS', nextText: 'NEXT' },
    f = 'docsify-pagination-container';
  function d(n) {
    return Array.prototype.slice.call(n);
  }
  function g(n) {
    return d(n.children).find(function (n) {
      return n.tagName && 'A' === n.tagName.toUpperCase();
    });
  }
  var m = (function () {
    function e(n) {
      t(this, e), n && (this.hyperlink = g(n));
    }
    return (
      s(e, [
        {
          ...
          n &&
            (n.innerHTML = h.inner(
              (function (n) {
                try {
                  var t = n.route.path,
                    e = d(o.all('.sidebar li a')).filter(function (n) {
                      return !l(n, '.section-link');
                    }),
                    i = e.find(function (n) {
                      return n.getAttribute('href') === '#' + t;
                    }),
                    r = d((c(i, 'ul') || {}).children).filter(function (n) {
                      return 'LI' === n.tagName.toUpperCase();
                    }),
                    a = r.findIndex(function (n) {
                      var e = g(n);
                      return e && e.getAttribute('href') === '#' + t;
                    });
                  return {
                    prev: new m(r[a - 1]).toJSON(),
                    next: new m(r[a + 1]).toJSON(),
                  };
                } catch (n) {
                  return {};
                }
